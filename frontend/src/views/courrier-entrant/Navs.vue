<template>
  <CRow>
    <CCol :xs="12">
      ...
      <CCard class="mb-4">
        <CCardHeader>
          <strong>Vue Navs</strong> <small>courrier navs</small>
        </CCardHeader>
        <CCardBody>
          <p class="text-body-secondary small">
            The courrier <code>.nav</code> component is built with flexbox and
          ...
          <DocsExample href="components/nav.html#courrier-nav">
            <CNav>
              <CNavItem>
